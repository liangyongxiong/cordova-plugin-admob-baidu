...
BannerAd.prototype.hide = function(options, successCallback, errorCallback) {
    exec(successCallback, errorCallback, 'BaiduAdMob', 'hideBannerAd', [JSON.stringify(options)]);
};
...
BannerAd.show = function(options) {
    ...
    exec(cb, cb, 'BaiduAdMob', 'showBannerAd', [JSON.stringify(options)]);
    return ad;
};
...
InterstitialAd.prototype.hide = function(options, successCallback, errorCallback) {
    exec(successCallback, errorCallback, 'BaiduAdMob', 'hideInterstitialAd', [JSON.stringify(options)]);
};
...
InterstitialAd.show = function(options) {
    ...
    exec(cb, cb, 'BaiduAdMob', 'showInterstitialAd', [JSON.stringify(options)]);
    return ad;
};
...
SplashAd.show = function(options) {
    ...
    exec(cb, cb, 'BaiduAdMob', 'showSplashAd', [JSON.stringify(options)]);
    return ad;
};
